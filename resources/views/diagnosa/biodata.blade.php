...
@section('content')
<div class="main-content-wrapper-biodata">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <div class="form-container" data-aos="fade-up">
                    ...
                    <div class="stepper">
                        <div class="line-progress" style="width: 33.33%;"></div>
                    ...
                    <form action="{{ route('diagnosa.biodata.submit') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama', $namaTerisiOtomatis ?? '') }}" placeholder="Masukkan nama lengkap Anda" required>
                        </div>
                        <div class="mb-4">
                            <label for="usia" class="form-label">Usia (Tahun)</label>
                            <input type="number" class="form-control" id="usia" name="usia" value="{{ old('usia', $usiaDariSesi ?? '') }}" placeholder="Masukkan usia Anda" required min="0" max="150">
                        </div>
